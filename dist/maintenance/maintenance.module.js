    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: maintenance_request_schema_1.MaintenanceRequest.name,
                    schema: maintenance_request_schema_1.MaintenanceRequestSchema,
                },
            ]),
            properties_module_1.PropertiesModule,
        ],
        controllers: [maintenance_controller_1.MaintenanceController],
        providers: [maintenance_service_1.MaintenanceService, maintenance_events_service_1.MaintenanceEventsService],
